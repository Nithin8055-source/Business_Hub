...
import { useAuth, useRealtimeDB } from '@/firebase';
import { signUpWithEmailAndPassword } from '@/firebase/auth/auth-service';
...
export default function SignUpPage() {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    setIsLoading(true);
    try {
      await signUpWithEmailAndPassword(auth, db, values.email, values.password, values.fullName);
      router.push('/');
    } catch (error: any) {
      console.error(error);
      toast({
